...
export const useAddVehicleCost = () =>
  useMutation<Partial<VehicleCost>, VehicleCost>(addVehicleCost, { parseFieldError: true });

export const useUpdateVehicleCost = () =>
  useMutation<Partial<VehicleCost>, VehicleCost>(updateVehicleCost, { parseFieldError: true });
