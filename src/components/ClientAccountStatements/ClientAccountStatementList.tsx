...
import { ClientAccountStatementDetail } from './ClientAccountStatementDetail';
...
type ClientAccountStatementListProps = {
...
export const ClientAccountStatementList = ({
  items,
  isLoading,
  error,
  currentPage,
  ...
  onPageChange,
  onPageSizeChange,
}: ClientAccountStatementListProps) => {
              ...
              {items.map((item, index) => (
                ...
                >
                  ...
                  <Box position="absolute" top="0.25rem" right="0.25rem">
                    <ClientAccountStatementDetail item={item} />
                  </Box>
                </Box>
              ))}
            </VStack>
