...
type GenericAccountStatementFiltersProps = {
  onFilterChange: (filters: AccountStatementFilters) => void;
  disabled?: boolean;
  totalBalance?: string;
};

export const GenericAccountStatementFilters = ({
  onFilterChange,
  disabled = false,
  totalBalance,
}: GenericAccountStatementFiltersProps) => {
